...
## 变更历史
- [202609241100_directional-grid-r2faster](../../history/2026-09/202609221630_directional-grid/) - v1.7.3 第四变体 r2faster A/B（单次确认/阈值40/ADX15，保留4H否决）
- [202609221630_directional-grid](../../history/2026-09/202609221630_directional-grid/) - 阶段0 探针 + 阶段1 信号影子系统（dev006）；v1.7.1 Review1 修复（费率分段/断档回放/MTM 入口径/覆盖率闸门/1H ATR/盘口口径）
